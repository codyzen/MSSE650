...
//this is already done in CoreDataMgr in AppDelegate
...
- (Workout *) createManagedWorkout{
    ...
    Workout *workout = [NSEntityDescription insertNewObjectForEntityForName:@"Workout" inManagedObjectContext:[CoreDataMgr getContext]];
...
- (NSArray *) retrieveAllWorkouts {
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Workout" inManagedObjectContext:[CoreDataMgr getContext]];
...
- (Workout *) deleteWorkout: (Workout *) workout {
    ...
    if([workout.name isEqualToString:@""]){
        ...
        [[CoreDataMgr getContext] deleteObject:workout];
    }
